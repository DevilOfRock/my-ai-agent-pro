...
def setup_page():
    # เพิ่ม initial_sidebar_state ให้มันกางออกเป็นค่าเริ่มต้นตอนเข้าเว็บด้วยเลยครับ
    st.set_page_config(page_title="AI Agent Pro", page_icon="✨", layout="wide", initial_sidebar_state="expanded")
...
def load_css(theme):
    ...
    st.markdown(f"""
        ...
        /* 2. Header โปร่งใส (ปล่อยปุ่มกางเมนูไว้ตามธรรมชาติ ไม่ไปแตะต้องมัน) */
        header {{ background: transparent !important; }}
        
        /* 3. ซ่อนเมนูด้านขวาบน (Deploy / จุด 3 จุด) แบบเจาะจง */
        #MainMenu {{ visibility: hidden; }}
        [data-testid="stHeaderActionElements"] {{ display: none !important; }}
        
        /* 4. สไตล์ตัวอักษรและสีพื้นฐาน */
